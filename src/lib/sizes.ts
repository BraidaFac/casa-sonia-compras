 ...
 */
export function getLetterSizeRange(from: LetterSize, to: LetterSize): LetterSize[] {
 ...
 */
export function getNumericSizeRange(from: number, to: number, step: number): string[] {
